...
class TestPcapMatcher(unittest.TestCase):
  def setUp(self):
    ...
    '''cai3g request, session id is a8c00401a8c00401000000001423682236048'''
  ...
  def test_match(self):
    '''cai3g request, session id is a8c00401a8c00401000000001423682236050'''
    recevied = self.req_load.replace("150.236.225.94", "10.170.31.213").replace("a8c00401a8c00401000000001423682236048", "a8c00401a8c00401000000001423682236050")
    expected_res = self.res_load.replace("a8c00401a8c00401000000001423682236048", "a8c00401a8c00401000000001423682236050")
